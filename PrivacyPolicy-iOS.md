...
- Generate lottery tickets using various distribution strategies.
...
To operate the app and serve ads, we or our third-party partners may collect certain information, as described below.
...
- We do not collect or request:
  - Names, email addresses, or other personally identifiable contact information.
  - Financial information (such as payment or banking details).
  - Social media profiles or login credentials.
  - Health, biometric, or other highly sensitive personal data.


4. Data Use

The information collected by LottoLedger and the Google AdMob SDK is used for the following purposes:
...
- Other than Google AdMob, LottoLedger does not integrate with or use:
...
Depending on your jurisdiction, you may have certain rights with respect to your personal data under privacy laws such as:

- California (CCPA/CPRA)
- European Union (GDPR)
- Texas (TDPSA)
- Colorado, Virginia, and other U.S. states

These rights may include:

- The right to know and access the categories of personal data collected.
...
LottoLedger is not directed to children under the age of 13, and we do not knowingly collect or process personal data from children under 13.

Where required by law (for example, under the COPPA framework), we do not allow the use of data-intensive or personalized advertising features for users whose age or context indicates that they may be children. If you believe a child under 13 is using the app in a way that may involve data collection, you may contact us so we can investigate.


9. Contact and Support

If you have questions about this privacy policy, data-handling practices, or technical issues with LottoLedger, you can contact us at:

- Support / Issue Reports (GitHub): https://github.com/Clutch-City-AppWorks/LottoLedger-support
- Email: support@clutchcityappworks.com
- Developer: Clutch City AppWorks LLC
  Montgomery County, Texas 77386
